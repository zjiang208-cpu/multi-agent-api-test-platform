...
<p align="center"><img src="../screenshots/01-project-overview.png" width="960" alt="项目概览：显示当前项目、任务进度和下一步操作"></p>
...
<p align="center"><img src="../screenshots/02-requirement-document.png" width="960" alt="需求文档：上传文件或直接粘贴内容"></p>
...
<p align="center"><img src="../screenshots/03-requirement-parsed.png" width="960" alt="需求文档解析成功：显示文档统计和识别到的接口数量"></p>
...
<p align="center"><img src="../screenshots/04-interface-catalog.png" width="960" alt="接口目录：展示接口方法、路径、说明和需求来源"></p>
...
<p align="center"><img src="../screenshots/05-requirement-analysis.png" width="960" alt="需求分析：后台分析当前接口的需求和测试点"></p>
...
<p align="center"><img src="../screenshots/06-requirement-confirmation.png" width="960" alt="需求确认：查看业务规则、测试点和辅助证据"></p>
...
<p align="center"><img src="../screenshots/07-test-case-design.png" width="960" alt="用例设计：显示接口处理进度和后台设计状态"></p>
...
<p align="center"><img src="../screenshots/08-test-cases.png" width="960" alt="测试用例：按接口查看并批量选择生成的用例"></p>
...
<p align="center"><img src="../screenshots/09-execution-confirmation.png" width="960" alt="执行确认：确认接口数量、用例数量和自动回归策略"></p>
...
<p align="center"><img src="../screenshots/10-test-report.png" width="960" alt="测试报告：查看 PASS、FAIL、HTTP 状态和断言结果"></p>
